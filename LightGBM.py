...
# Model 1: LightGBM without tuning
model_default = lgb.LGBMClassifier(boosting_type="gbdt", objective="binary", metric="auc", random_state=42)
model_default.fit(X_train, y_train)

# Model 2: LightGBM with tuning
param_grid = {
    'num_leaves': [15, 31, 50],
